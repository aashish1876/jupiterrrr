  ...
  const pillars = [
    {
      ...
      description: 'Strategic migration blueprints from on-premises legacy environments to scalable, cloud-native operational models.',
      icon: Cloud,
    },
    {
      title: 'Enterprise Infrastructure',
      description: 'Bare-metal, hyperconverged, and high-performance compute architectures engineered for sub-millisecond mission-critical throughput.',
      icon: Server,
    },
    {
      title: 'Cloud Architecture',
      description: 'Multi-region Kubernetes clusters, serverless event fabrics, and decoupled microservices with deterministic fault isolation.',
      icon: Cpu,
    },
    {
      title: 'Enterprise Storage',
      description: 'Distributed petabyte-scale object storage, high-IOPS block storage, and tiering systems with verified data integrity.',
      icon: HardDrive,
    },
    {
      title: 'Automated Backup',
      description: 'Immutable, air-gapped point-in-time snapshots and continuous replication protocols safeguarding core business databases.',
      icon: Database,
    },
    {
      title: 'Disaster Recovery',
      description: 'Sub-second recovery time objective (RTO) and zero recovery point objective (RPO) multi-cloud active-active failover mechanisms.',
      icon: ShieldAlert,
    },
    {
      title: 'Core Modernization',
      description: 'Containerisation, legacy database refactoring, and automated CI/CD deployment pipelines that eradicate operational friction.',
      icon: Repeat,
    },
    {
      title: 'Hybrid Infrastructure',
      description: 'Unified control planes bridging sovereign on-premise hardware enclaves seamlessly with AWS, Google Cloud, and Azure.',
      icon: Network,
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.15]">
                Cloud & <br />
                <span className="text-[#F4BC43]">Infrastructure.</span>
              </h1>
              <p className="text-base sm:text-lg text-[#B7C0CC] leading-relaxed max-w-2xl font-normal">
                Cloud transformation, enterprise infrastructure, storage, backup, and modernization. We engineer 99.999% uptime architectures where downtime is never an option.
              </p>
              <div className="pt-2 flex flex-wrap gap-4">
                ...
                >
                  Consult Infrastructure Architects →
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-3 mb-16">
          ...
          <p className="text-sm sm:text-base text-[#B7C0CC] max-w-2xl mx-auto">
            High-availability compute, automated disaster recovery, and sovereign hybrid cloud systems.
          </p>
        </div>
